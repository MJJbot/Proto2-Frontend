      ...
      <v-flex lg12>
        <v-card>
          <v-toolbar card color="white">
            <v-toolbar-title><h4>automaticQA</h4></v-toolbar-title>
            <v-divider
              class="mx-4"
              inset
              vertical
...
export default {
  ...
  methods: {
    ...
    deleteItem (item) {
      ...
      api.delete('http://211.254.217.44:8893/automaticQA/'+this.questions[index].id)
      .then(()=>{
        this.update()
      })
    },
    ...
    save () {
      ...
      api.put('http://211.254.217.44:8893/automaticQA/'+this.questions[this.editedIndex].id, this.editedItem)
      .then((result) => {
        this.update()
      })
      this.close()
